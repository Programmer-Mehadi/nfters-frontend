      ...
      <div className="max-w-[1200px] p-5 mx-auto">
        <div className="py-14 grid md:grid-cols-2 lg:grid-cols-3 gap-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="text-[#565656] text-sm not-italic font-normal leading-[160%]">
            ...
            <div className="flex gap-4 items-center">
              <a
                href="https://www.facebook.com/md.mehadi.talukder/"
                target="_blank"
              >
                <svg
              ...
              <a
                href="https://twitter.com/i/flow/login?redirect_after_login=%2FMuhammadMehadi"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                href="https://www.linkedin.com/in/muhammad-mehadi/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="grid md:grid-cols-2 gap-20">
            <div className="flex flex-col gap-8">
              ...
              <ul className="text-[#3D3D3D] text-sm not-italic font-medium leading-[200%]">
                <li>All NFTs </li>
                <li>New </li>
                <li>Art</li>
                <li>Sports</li>
          ...
          <div>
            <div className="flex flex-col gap-8">
              ...
              <p className="text-[#363639] text-sm not-italic font-normal leading-[160%]">
              ...
              <div className="relative h-[60px]">
                <TextInput
                  ...
                  value={email}
                  thisRef={emailRef}
                  setValueOnState={setEmail}
                  className="h-[60px] max-w-[100%] placeholder:text-xs"
                />
                <Button
        ...
        <p className="text-[#A4A4A4] text-sm not-italic font-normal leading-[160%] text-center py-4">
          ...
          <span className="text-[#3D00B7] opacity-90 cursor-pointer">
            {" "}
            <a href="https://github.com/Programmer-Mehadi" target="_blank">
              Muhamamd Mehadi
            </a>
          </span>
        </p>
